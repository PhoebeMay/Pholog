...
\textbf{Key summary}
\begin{itemize}
\item 16\textsuperscript{th} Dec: Success criteria met
\item 1\textsuperscript{st} Feb: Progress report deadline
\item 24\textsuperscript{th} Feb: Draft dissertation completed
\item 17\textsuperscript{th} May: Dissertation deadline
\end{itemize}
...
\item Example programs written in OCaml and Prolog.
\end{itemize}

\daterange{14}

Implement a lexer and parser for the chosen subset of Prolog. I am intending to use ocamllex and ocamlyacc (described in \cite{ocamlyacc}) for this.
...
\daterange{14}
\hfill{\emph{\textbf{30\textsuperscript{th} Nov}: Last day of Michaelmas term}}
...
\daterange{14} [\emph{Slack}] \hfill{\emph{\textbf{15\textsuperscript{th} Jan}: First day of Lent term}}
...
\daterange{14} \hfill{\emph{\textbf{15\textsuperscript{th} Mar}: Last day of Lent term}}
...
\daterange{14}  \hfill{{\emph{\textbf{23\textsuperscript{rd} Apr}: First day of Easter term}}}

Make any final changes and submit the dissertation.

Milestones:
\begin{itemize}
\item Dissertation submitted. \hfill{\emph{\textbf{17\textsuperscript{th} May}: Dissertation deadline}}
\end{itemize}
...
The basic resources that are essential to my project are the OCaml compiler \texttt{ocamlopt} and the SWI-Prolog interpreter \texttt{swipl}. These are both installed on the MCS system, so I will be able to complete the project using the MCS machines if my laptop fails.

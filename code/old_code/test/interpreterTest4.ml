...
?- plant(X)
"
    (Ans(Resolvant([Atom("plant",[TFun("flower",[TVar("Argument: 0")])])])))
...
?- f(struct(X))
"
    (Ans(Resolvant([Atom("f",[TFun("struct",[TVar("Inner: 0")])])]))
    )
...
?- f(X)
"
    (Ans(Resolvant([Atom("f",[TFun("struct",[TVar("Argument: 0")])])])))
...
"
    (Ans(Resolvant([
         Atom("f",[TFun("struct",[TFun("build",[TVar("Argument: 0")])])]
             )])))

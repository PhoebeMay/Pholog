...
type functionId = AbstractF of (string * int)
                | PositionF of int [@@deriving sexp, show]


type clausePos = AbstractC of functionId * int
               | PositionC of int [@@deriving sexp, show]
...
type variable = InitV | HeapPointer of heapValue
              | TempInt of int [@@deriving show, sexp ]



type heapValueFlat = | UnboundVarF | InitHF
                     | StrPointerF of string * heapValueFlat array
                     | IntF of int [@@deriving show]


type variableFlat = InitVF | HeapPointerF of heapValueFlat
                  | TempIntF of int [@@deriving show]

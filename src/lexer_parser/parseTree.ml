...
type 'a atom = Atom of pred * 'a term list
[@@deriving show, sexp]

type 'a arithBase = Var of 'a | Int of int
[@@deriving show, sexp]
...
type 'a isExpr = IsExpr of 'a * 'a mathExpr
[@@deriving show, sexp]
...
type 'a typeins = IntTyp | TypeVar of 'a | TypeCons of string * 'a typeins list
[@@deriving show, sexp]
...
type 'a preddef = PredDef of string * 'a typeins list
[@@deriving show, sexp]

type 'a sentence_item = C of 'a clause | D of 'a typedef | P of 'a preddef
[@@deriving show,sexp]

type 'a sentence = Sentence of 'a sentence_item list
[@@deriving show,sexp]
...
type answer = Fail | Ans of string resolvant
[@@deriving show]
